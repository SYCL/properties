#ifndef SYCL_KHR_QUEUE_PROPERTIES_HPP
#define SYCL_KHR_QUEUE_PROPERTIES_HPP

#include "properties.hpp"

namespace sycl::khr {

// Stub queue tag for trait specialization (no real SYCL runtime).
struct queue_tag {};

// --- enable_profiling (runtime boolean property) ---
...
// --- in_order (runtime boolean property) ---
...
#endif // SYCL_KHR_QUEUE_PROPERTIES_HPP
